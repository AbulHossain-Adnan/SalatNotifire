...
use App\Http\Requests\SalatTimeRequest;
use Exception;
...
class SalatTimeController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('salatTime/index',compact('salatTimes'));
    }
    ...
    {
        return view("salatTime.edit",compact('salat_time'));
    }
