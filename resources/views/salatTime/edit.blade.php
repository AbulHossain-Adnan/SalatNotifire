    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="card">
                    <div class="card-header text-white bg-primary">Salat Time Update</div>
                    <div class="card-body">
                        <!-- Action Button -->
                        ...
                        <!-- Edit Form -->
                        <form action="{{ route('salat-times.update', $salat_time->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <input 
                                    ...
                                    id="salatInput" 
                                    name="salat" 
                                    value="{{ old('salat', $salat_time->salat) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input 
                                    ...
                                    name="time" 
                                    value="{{ old('time', $salat_time->time) }}" 
